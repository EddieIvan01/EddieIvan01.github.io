...
summary: ichunqiu新春战疫公益赛 && 安恒新春抗疫 && XCTF高校战疫 && CONFidenceCTF2020 && 数字中国虎符
...
参数存在过滤，其实我都不知道有过滤，知道是JS后就fuzz了`?code[]=`传参。过滤逻辑应该是`input.indexOf(black_list_word) != -1`，数组自然绕过，且JS中`['exp'].toString == 'exp'`
