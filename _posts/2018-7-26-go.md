...
func (soup restring) re_match() {
	...
	title_slice := re_title.FindAllString(string(soup), -1)
	price_slice := re_price.FindAllString(string(soup), -1)
	nick_slice := re_nick.FindAllString(string(soup), -1)
	loc_slice := re_loc.FindAllString(string(soup), -1)
